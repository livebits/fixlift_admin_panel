...
import {
    ...
    ReferenceArrayInput, SelectArrayInput, translate, Edit
} from 'react-admin';
import { required, minLength, FormDataConsumer, GET_ONE } from 'ra-core';
import dataProvider from '../dataProvider/dataProvider';
import { withStyles } from '@material-ui/core';

class DPHEdit extends React.Component {
    ...
    render() {
        return <Edit title="ویرایش آیتم فرم قرارداد" {...this.props}>
            <SimpleForm>
...
export default withStyles()(DPHEdit);