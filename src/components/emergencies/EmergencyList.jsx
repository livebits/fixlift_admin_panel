...
import {
    ArrayField, SingleFieldList, ChipField, List, EmailField, Responsive, Datagrid, TextInput,
...
const ListFilter = (props) => (
    <Filter {...props}>
        ...
        <SelectInput source="emgType" label="نوع امداد" optionText="name" alwaysOn resettable choices={[
            { id: 'all', name: 'همه' },
            { id: 'done', name: 'امداد های انجام شده' },
            { id: 'undone', name: 'امداد های انجام نشده' },
        ]} />
        <SelectInput source="emgTime" label="زمان امداد" optionText="name" alwaysOn resettable choices={[
            { id: 'all', name: 'همه' },
...
export const EmergencyList = props => (
    <List {...props} title='مدیریت امداد ها' filters={<ListFilter />} perPage={25}>
        ...
        <Datagrid rowClick='edit'>
            ...
            <FunctionField source='time' label='تاریخ  ثبت امداد' render={record => castDateToJalali(record.time)} />
            <FunctionField source='doneTime' label='تاریخ انجام' render={record => castDateToJalali(record.doneTime)} />
