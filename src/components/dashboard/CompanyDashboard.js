                        ...
                        <GridItem xs={12} sm={6} md={3}>
                            <Card>
                                <CardHeader color="success" stats icon>
                                    ...
                                    <p className={classes.cardCategory}>خرابی های رفع نشده</p>

                                </CardHeader>
                                <CardFooter stats>
                                    <h3 className={classes.cardTitle}>234,345,112</h3>
                                </CardFooter>
                            </Card>
                        </GridItem>
                        ...
                        <GridItem xs={12} sm={6} md={3}>
                            <Card>
                                <CardHeader color="success" stats icon>
                                    ...
                                    <p className={classes.cardCategory}> سرویس های انجام نشده</p>

                                </CardHeader>
                                <CardFooter stats>
                                    <h3 className={classes.cardTitle}>24,456</h3>
                                </CardFooter>
                            </Card>
                        </GridItem>
                        ...
                        <GridItem xs={12} sm={6} md={3}>
                            <Card>
                                <CardHeader color="success" stats icon>
                                    ...
                                    <p className={classes.cardCategory}> گزارشات سرویس کاران</p>

                                </CardHeader>
                                <CardFooter stats>
                                    <h3 className={classes.cardTitle}>124,434</h3>
                                </CardFooter>
                            </Card>
                        </GridItem>
                        ...
                        <GridItem xs={12} sm={6} md={3}>
                            <Card>
                                <CardHeader color="success" stats icon>
                                    ...
                                    <p className={classes.cardCategory}> قراردادهای رو به پایان</p>

                                </CardHeader>
                                <CardFooter stats>
                                    <h3 className={classes.cardTitle}>2,345,345</h3>
                                </CardFooter>
                            </Card>
                        </GridItem>
                        ...
                        <GridItem xs={12} sm={6} md={3}>
                            <Card>
                                <CardHeader color="success" stats icon>
                                    ...
                                    <p className={classes.cardCategory}> بیمه های رو به پایان</p>

                                </CardHeader>
                                <CardFooter stats>
                                    <h3 className={classes.cardTitle}>23,234,344</h3>
                                </CardFooter>
                            </Card>
                        </GridItem>
                        ...
                        <GridItem xs={12} sm={6} md={3}>
                            <Card>
                                <CardHeader color="success" stats icon>
                                    ...
                                    <p className={classes.cardCategory}> سرویس های انجام شده این ماه</p>
                        ...
                        <GridItem xs={12} sm={6} md={3}>
                            <Card>
                                <CardHeader color="success" stats icon>
                                    ...
                                    <p className={classes.cardCategory}> خرابی های انجام شده این ماه</p>
